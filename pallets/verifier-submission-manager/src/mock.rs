...
use crate as pallet_verifier_submission_manager;
...
frame_support::construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        VerifierSubmissionManager: pallet_verifier_submission_manager,
...
parameter_types! {
    ...
    pub const MaxVerifierSubmissions: u32 = 10;
    pub const VerificationTimeOut: u64 = 10;
    pub const SubmissionFee: u64 = 10;
    pub const ExistentialDeposit: u128 = 1;
    pub const VerifierSubmissionManagerPalletId: frame_support::PalletId = frame_support::PalletId(*b"py/vlmgr");
    ...
    pub const VerifierRewardPercentage: u8 = 10; // Verifiers share 50%
...
impl pallet_verifier_submission_manager::Config for Test {
    type TreasuryManager = Test;
    type Currency = Balances;
    type RuntimeEvent = RuntimeEvent;
    type MaxVerifierSubmissions = MaxVerifierSubmissions;
    type VerificationTimeout = ConstU64<5>; // Timeout in blocks
    type TotalReward = TotalReward;
    //type WeightInfo = ();
}
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    ext.execute_with(|| {
        crate::VerifierSubmissions::<Test>::remove_all(None);
        crate::VerificationDeadline::<Test>::remove_all(None);
