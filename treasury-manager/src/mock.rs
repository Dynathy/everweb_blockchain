...
use crate as pallet_treasury_manager;
...
frame_support::construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        TreasuryManager: pallet_treasury_manager,
    }
);
...
impl pallet_treasury_manager::Config for Test {
    ...
    type RuntimeEvent = RuntimeEvent;
    type TreasuryPalletId = TreasuryManagerPalletId;
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    // Initialize balances for relevant accounts
